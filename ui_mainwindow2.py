...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_7.addWidget(self.Grafo_plainTextEdit, 0, 0, 1, 1)

        self.Grafo_M_pushButton = QPushButton(self.tab_4)
        self.Grafo_M_pushButton.setObjectName(u"Grafo_M_pushButton")

        self.gridLayout_7.addWidget(self.Grafo_M_pushButton, 1, 0, 1, 1)

        self.Grafo_graphicsView = QGraphicsView(self.tab_4)
        self.Grafo_graphicsView.setObjectName(u"Grafo_graphicsView")

        self.gridLayout_7.addWidget(self.Grafo_graphicsView, 0, 1, 4, 1)

        self.Grafo_L_pushButton = QPushButton(self.tab_4)
        self.Grafo_L_pushButton.setObjectName(u"Grafo_L_pushButton")

        self.gridLayout_7.addWidget(self.Grafo_L_pushButton, 2, 0, 1, 1)

        self.groupBox_3 = QGroupBox(self.tab_4)
        self.groupBox_3.setObjectName(u"groupBox_3")
        self.formLayout_2 = QFormLayout(self.groupBox_3)
        self.formLayout_2.setObjectName(u"formLayout_2")
        self.Busquedas_plainTextEdit = QPlainTextEdit(self.groupBox_3)
        self.Busquedas_plainTextEdit.setObjectName(u"Busquedas_plainTextEdit")

        self.formLayout_2.setWidget(0, QFormLayout.FieldRole, self.Busquedas_plainTextEdit)
        ...
        self.Busqueda_x_spinBox = QSpinBox(self.groupBox_3)
        self.Busqueda_x_spinBox.setObjectName(u"Busqueda_x_spinBox")
        self.Busqueda_x_spinBox.setMaximum(500)

        self.formLayout_2.setWidget(1, QFormLayout.FieldRole, self.Busqueda_x_spinBox)
        ...
        self.Busqued_y_spinBox = QSpinBox(self.groupBox_3)
        self.Busqued_y_spinBox.setObjectName(u"Busqued_y_spinBox")
        self.Busqued_y_spinBox.setMaximum(500)

        self.formLayout_2.setWidget(3, QFormLayout.FieldRole, self.Busqued_y_spinBox)

        self.Busqueda_pushButton = QPushButton(self.groupBox_3)
        self.Busqueda_pushButton.setObjectName(u"Busqueda_pushButton")

        self.formLayout_2.setWidget(4, QFormLayout.FieldRole, self.Busqueda_pushButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_3.setTitle(QCoreApplication.translate("MainWindow", u"Busqueda", None))
        ...
        self.Busqueda_pushButton.setText(QCoreApplication.translate("MainWindow", u"Profundida y Amplitud", None))
